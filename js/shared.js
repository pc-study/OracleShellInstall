...
const i18n = {
  zh: {
    home: '首页', generator: '命令生成器', docs: '使用文档', compat: '安装合集', pricing: '脚本订阅', download: '下载中心', contribute: '投稿分享', cases: '实战案例', links: '友情链接', start: '开始使用',
  ...
  en: {
    // nav & shared
    home: 'Home', generator: 'Generator', docs: 'Docs', compat: 'Guides', pricing: 'Subscribe', download: 'Download', contribute: 'Contribute', cases: 'Case Studies', links: 'Links', start: 'Get Started',
    ...
    cl52a: 'Full Oracle 26ai installation support',
    cl52b: 'Added Debian 12.10 support, fixed ARM bugs',
    cl52c: 'Added Anolis 23.2, openEuler 24.09 support',
    cl52d: 'Added CTyunOS (China Telecom Cloud) support',
    cl52e: 'Added CentOS / RHEL 10 support for Oracle 11G ~ 23ai',
    cl51a: 'Added openSUSE / SUSE 15.6 support',
    cl51b: 'Fixed charset support, expanded to all 247 database character sets',
    cl51c: 'Added Ubuntu (Deb) series Oracle RAC support',
    cl51d: 'Added -hf parameter for automatic HugePages configuration',
    cl51e: 'Added -debug script debugging parameter',
    cl51f: 'Added Oracle 23ai preview edition support',
    cl51g: 'Full Linux ARM (aarch64) 19C installation support',
    cl51h: 'Added custom username parameters -ou / -gu',
    cl51i: 'Added nvme disk multipath configuration',
    cl51j: 'Added Huawei Cloud HCE aarch, TencentOS 2/3/4, Inspur KeyarchOS 5 support',
    cl50a: 'Gen-5 release \u2014 compatible with 99% of mainstream Linux distributions',
    cl50b: 'Removed -iso parameter, added -lrp / -lnp repo configuration parameters',
    cl50c: 'Added -dbs parameter for database block size (2048 ~ 32768)',
    cl50d: 'Rewrote software repo, package installation, and OS adaptation logic',
    cl50e: 'Rewrote DBCA database creation using response file method',
    cl50f: 'Support complex passwords (removed password complexity restrictions)',
    cl50g: 'Rewrote online redo log logic for smarter configuration',
    cl50h: 'Added -o parameter name validation (length, character rules)',
    cl50i: 'Improved SSH trust logic for higher RAC success rate',
    cl40a: 'Gen-4 release \u2014 full support for mainstream domestic operating systems',
    cl40b: 'Supports openEuler 20~23, Anolis 7/8, UOS V20, Kylin V10, NeoKylin V7',
    cl40c: 'Added -giv parameter for separate GI and DB version installation',
    cl40d: 'Added -o parameter for one-click multi-instance creation',
    cl40e: 'Improved installation output with step-by-step and total timing',
    cl40f: 'Added SUSE 15 SP5, Fedora 39 support',
    cl40g: 'Added RHEL 9 Oracle 19C support (requires RU patch \u2265 19.19)',
    cl40h: 'Added pre-installation checks for domestic OS deployments',
    cl30a: 'RAC mode supports unlimited nodes',
    cl30b: 'Added Standalone ASM mode',
    cl30c: 'Added -fd parameter for multipath disk filtering',
    cl30d: 'Support direct udev disk binding without multipath',
    cl30e: 'Added Kylin V10 support for Oracle 11gR2 / 12cR2 / 19c',
    cl30f: 'Added Linux 8 support for Oracle 11gR2 single instance',
    cl30g: 'Fully localized installation output to Chinese',
    cl20a: 'Rewrote OracleShellInstall script (Gen-2)',
    cl20b: 'Added parameters: -redo / -pdb / -er / -opd / -lf / -dp',
    cl20c: 'Added -jpa parameter for OJVM patch installation',
    cl20d: 'Added -adc for script-free ASM disk config (multipath + udev)',
    cl20e: 'Support RAC 3+ node installation (removed 2-node limit)',
    cl20f: 'Added automatic swap configuration, multiplexed control files',
    cl10a: 'Created OracleShellInstall script',
    cl10b: 'Basic Oracle single-instance installation support',
...
function footerHTML() {
  ...
  return `<footer class="footer"><div class="container"><div class="footer-inner">
    ...
    <div class="footer-col"><h4 data-i18n="nav">${t('nav')}</h4>
      ...
      <a href="${p}links.html" data-i18n="links">${t('links')}</a>
    </div>
