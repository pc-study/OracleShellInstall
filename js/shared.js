...
document.addEventListener('DOMContentLoaded', () => {
  ...
  popup.innerHTML = `<button class="wechat-popup-close" aria-label="Close">&times;</button>
    ...
    <a class="consult-discord-link" href="https://discord.gg/jumXJDmW" target="_blank" rel="noopener noreferrer">
    ...
    <a class="consult-wa-link" href="https://wa.me/8616619904622" target="_blank" rel="noopener noreferrer">
  ...
  document.querySelectorAll('pre').forEach(pre => {
    ...
    copyBtn.addEventListener('click', () => {
      ...
      navigator.clipboard.writeText(text).then(() => {
        ...
        copyBtn.innerHTML = '<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>Copied!';
        setTimeout(() => {
